...
sleep(1000);
	...
	rotateToAngle(270, 2000);
		...
		writeDebugStreamLine("Cerrado");
	sleep(1000000);

	//Throw the stars
	armThrowWhileMoving(1200, 24);

	//Turn the robot in the way of the cube
	rotateThisAngle(315, 2000);
